...
namespace WPF_WMS01.ViewModels.Popups
{
    public class SelectProductionLinePopupViewModel : ViewModelBase
    {
        ...
        public SelectProductionLinePopupViewModel(string lotNo)
        {
            ...
            {
                new ProductionLineLocation { Id = 1, Name = "223#1 A" },
                new ProductionLineLocation { Id = 2, Name = "223#1 B" },
                new ProductionLineLocation { Id = 3, Name = "223#2 A" },
                new ProductionLineLocation { Id = 4, Name = "223#2 B" },
                new ProductionLineLocation { Id = 5, Name = "308" },
